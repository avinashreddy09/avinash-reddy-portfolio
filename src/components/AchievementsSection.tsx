          ...
          <div className="bg-card p-6 rounded-card shadow-smooth h-full hover:-translate-y-1 transition-transform duration-300">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-primary mt-1 tabular-nums">300+ Problems</p>
                <p className="text-sm text-body mt-2 text-pretty">
                  Solved 300+ LeetCode problems, primarily medium and hard difficulty, focusing on data structures, algorithms, and optimization techniques.
                </p>
                <a
